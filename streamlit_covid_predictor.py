...
def render_contact():
    ...
    st.markdown(
        ...
        '<div style="font-size:.8rem;color:#FFA700;font-weight:700;margin-bottom:2px;">Researcher &amp; Developer</div>'
        '<div style="font-size:.78rem;color:#BFDBFE;margin-bottom:2px;">MSc Data Analytics · A00050350</div>'
        ...
        '<div style="font-size:.8rem;color:#FFA700;font-weight:700;margin-bottom:2px;">Host Institution</div>'
        '<div style="font-size:.78rem;color:#BFDBFE;margin-bottom:2px;">School of Computing</div>'
        '<div style="font-size:.78rem;color:#BFDBFE;margin-bottom:10px;">Dublin, Ireland · DCU F-REC Ethics Approved</div>'
        '<div style="font-size:.75rem;color:rgba(255,255,255,.7);margin-bottom:12px;line-height:1.55;">'
        'One of Ireland\'s leading universities for computing and data science research, '
        'ranked in the top 2% globally. Home to world-class research centres in AI, '
        ...
        '<a href="https://www.dcu.ie/researchsupport/research-ethics" target="_blank" '
        'style="color:#93C5FD;font-size:.8rem;text-decoration:none;">DCU Research Ethics (F-REC)</a>'
        '</div></div>'
        '</div></div>',
        unsafe_allow_html=True)
